                ...
                htmlContent: `
                    <div style="font-family: 'Poppins', Arial, sans-serif; background-color: #071a0f; color: #ffffff; padding: 30px; border-radius: 12px; max-width: 600px; margin: auto;">
                        ...
                        <div style="text-align: center; margin: 30px 0;">
                            <a href="https://nextelconnect.vercel.app/submit-proof.html" style="background-color: #C9A84C; color: #071a0f; padding: 12px 25px; border-radius: 6px; text-decoration: none; font-weight: bold; display: inline-block;">📤 SUBMIT PAYMENT PROOF</a>
                        </div>
